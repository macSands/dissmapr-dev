...
```{r map-aoi, fig.alt="Observation density across South Africa (0.5° grid)"}
ggplot2::ggplot() +
...
```{r eff-rich, fig.alt="Sampling effort (√obs count) and Species richness (√unique count)"}
...
#   list(
#     rsa = rsa,
#     grid_r = terra::unwrap(grid_r),
#     grid_sf =grid_sf,
#     grid_spp= grid_spp,
#     effRich_r = terra::unwrap(effRich_r),
