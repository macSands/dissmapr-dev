...
```{r zeta-decline-ex, fig.width=7, fig.height=5, fig.alt="Zeta decline EX"}
...
```{r zeta-decline-mc, fig.alt="Zeta decline MC"}
set.seed(123)
...
```{r zeta-decays, fig.alt="Zeta decays"}
...
```{r zeta-msgdm, fig.alt="Zeta iSplines"}
set.seed(123)
...
```{r zeta-msgdm-noeff, fig.alt="Zeta iSplines with no effort index"}
# Fit order-2 MSGDM on the presence–absence matrix and reduced covariate set
