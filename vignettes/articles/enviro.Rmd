...
rsa = inputs$rsa
grid_r = terra::unwrap(inputs$grid_r)
...
```{r ras, fig.alt="Environmental Covariates"}
...
```{r env-df, fig.alt="Grid-cell mean annual temperature (√-scaled)"}
...
```{r var-vif, message = FALSE, fig.alt="Environmental pairwise correlations"}
# (Optional) Rename BIO
