...
#> Error in calc_geodist(c(18.4, -33.9), c(28, -26.2)): could not find function "calc_geodist"
calc_geodist(c(centroid_lon = 18.4, centroid_lat = -33.9), NULL)
#> Error in calc_geodist(c(centroid_lon = 18.4, centroid_lat = -33.9), NULL): could not find function "calc_geodist"
```
