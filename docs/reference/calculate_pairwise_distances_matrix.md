...
#> Error in calculate_pairwise_distances_matrix(data = my_sites_df, x_col = "centroid_lon",     y_col = "centroid_lat", units = "m", triangle = "upper"): unused arguments (units = "m", triangle = "upper")
dist_unique %>% slice_head(n = 6)
#> Error: object 'dist_unique' not found
```
