...
#> Error in calc_cor_spear(c(1, 3, 5, 7, 9), c(2, 4, 6, 8, 10)): could not find function "calc_cor_spear"
calc_cor_spear(c(1, 3, 5), NULL)
#> Error in calc_cor_spear(c(1, 3, 5), NULL): could not find function "calc_cor_spear"
```
