...
#> Error in calc_distance(sites, "site", "A", "B"): could not find function "calc_distance"
calc_distance(sites, "site", "A", NULL)
#> Error in calc_distance(sites, "site", "A", NULL): could not find function "calc_distance"
```
